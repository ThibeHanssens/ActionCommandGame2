namespace ActionCommandGame.Ui.ConsoleApp.ConsoleWriters
{
    ...
    {
        public static Task Write(string text, int padding = 1, ConsoleColor color = ConsoleColor.White)
        {
            return Write(new List<string> { text }, padding, color);
        }

        public static Task Write(IList<string> textLines, int padding, ConsoleColor color)
        {
